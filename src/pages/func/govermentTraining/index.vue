<template>
    <Layout>
        ...
        <TableInfo :columns="columns" :dataSource="dataSource" slot="content">
             ...
             <p slot="periodfinishRate" slot-scope="props">
                <el-progress :text-inside="true" :stroke-width="18" :percentage="props.data.periodfinishRate"></el-progress>
            </p>
        </TableInfo>
...
<script>
    ...
    const TABLE_NAME = 'govermentTraining';
    export default {
        mixins: [mixin],
        components: {
            TableInfo,
