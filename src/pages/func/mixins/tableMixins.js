    ...
    methods: {
        ...
        adapterColumns(data) {
            return data.map((item) => {
                ...
                if (item.headId === 'photo' || item.headId === 'content' || item.headId === 'sign' || item.headId === 'finishRate' || item.headId === 'roadLicensePic' || item.headId === 'businessLicensePic') { // photo 需要图片展示  content 内容展示 sign 签字
                    tempPo.render = true;
                }
